      ...
      <el-card>
        <div class="table-constainer">
            ...
            <div class="right-operator">
              ...
              >
                ...
                >
                  ...
                  <el-option label="帐号" value="username"></el-option>
                </el-select>
                <el-button
                  slot="append"
                  icon="el-icon-search"
          ...
          <el-table
            ...
            :data="$store.state.user.listData.list"
            tooltip-effect="dark"
          ...
          <div class="table-bd clearfix">
            ...
            <div class="table-bd_right">
              <el-pagination
                ...
                :total="$store.state.user.listData.total"
...
export default {
  ...
  methods: {
    ...
    queryListData() {
      this.$store.dispatch("user/list", { payload: this.queryParams() });
    },
    // 生成查询条件
    queryParams() {
    ...
    handleDelete(ids) {
      ...
      this.$confirm("此操作将删除该数据, 是否继续?", "提示", {
        ...
        .then(() => {
          self.$store.dispatch("user/delete", {
            payload: { ids },
            callback: (resp) => {
              const { count } = resp;
              self.$message({
              ...
              const { list, pageNum, pageSize, total } =
                self.$store.state.user.listData;
