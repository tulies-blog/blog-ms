...
export function getUserInfo() {
  const userinfo = localStorage.getItem("blog-sso-userinfo");
  try {
...
export function setUserInfo(userinfo) {
  return localStorage.setItem("blog-sso-userinfo", JSON.stringify(userinfo));
}
// 清除用户信息
export function clearUserInfo() {
  return localStorage.removeItem("blog-sso-userinfo");
}
